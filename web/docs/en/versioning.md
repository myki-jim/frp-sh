...
- **Fast iteration**: v0.1.x ships almost weekly; follow along
...
- Every run prints the current version and protocol (`frp-sh v0.1.14 (protocol v1)`)
...
- `0.1.x`: feature work and fixes, shipped whenever ready
